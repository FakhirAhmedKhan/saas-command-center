...
/**
 * Actual HTTP query contract used by the API.
 *
 * Frontend UI filters currently use dateFrom/dateTo and translate
 * them separately, so that UI-specific type remains in apps/web.
 */
