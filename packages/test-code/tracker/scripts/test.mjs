...
if (withCoverage) {
  nodeArguments.push('--experimental-test-coverage', '--test-coverage-include=dist-coverage/**', '--test-coverage-exclude=unit/**', '--test-coverage-exclude=test-support/**', '--test-coverage-exclude=scripts/**');
}
