...
- Name: batch10\auth.spec.ts >> Batch 10 authentication flows >> registers a new account with the expected request payload
- Location: e2e\batch10\auth.spec.ts:83:7
