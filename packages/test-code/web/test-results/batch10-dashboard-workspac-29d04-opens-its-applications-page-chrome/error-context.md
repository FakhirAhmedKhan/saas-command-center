...
- Name: batch10\dashboard-workspaces.spec.ts >> Batch 10 dashboard and workspace flows >> creates a workspace and opens its applications page
- Location: e2e\batch10\dashboard-workspaces.spec.ts:77:7
            ...
            - generic [ref=e113]:
              ...
              - generic [ref=e118]:
                ...
                - textbox "Workspace URL" [ref=e121]:
                  - /placeholder: demo-command-center
                - paragraph [ref=e122]: command-center.app/analytics-team
              - generic [ref=e123]:
