...
- Name: batch10\navigation-accessibility.spec.ts >> Batch 10 navigation, responsiveness, and accessibility >> restores an authenticated session from the public root
- Location: e2e\batch10\navigation-accessibility.spec.ts:5:7
...
Locator: getByRole('heading', { name: 'Welcome back, Frontend Owner' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Welcome back, Frontend Owner' })
