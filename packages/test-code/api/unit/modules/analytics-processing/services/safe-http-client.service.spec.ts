...
describe(SafeHttpClientService.name, () => {
  ...
  it.each(['http://127.0.0.1:4000/health', 'http://0.0.0.0/health', 'http://localhost/health', 'http://169.254.169.254/latest/meta-data', 'http://[::1]/health', 'http://metadata.google.internal/'])(
