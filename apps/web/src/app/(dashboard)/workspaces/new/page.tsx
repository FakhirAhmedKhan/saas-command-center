    ...
    async function handleSubmit(
        ...
        try {
            ...
            window.location.assign(
                `/workspaces/${workspace.id}/applications`,
            );
                ...
                <div className="mt-6 flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500">
                            Separate your personal products,
                            client applications, and team
                            projects into independent
                            workspaces.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="flex items-start gap-3 rounded-2xl border border-blue-200 bg-blue-50 p-4">
                            ...
                            <div className="text-sm leading-6 text-blue-800">
                                ...
                                <p className="mt-1">
                                    ...
                                    technologies, links, and future
                                    activity history will remain
                                    separated from your other
                                    workspaces.
                                </p>
                            </div>
                        </div>
