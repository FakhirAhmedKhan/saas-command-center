...
import {
    WebsiteCard,
} from '@/features/websites/components/website-card';
            ...
            <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    ...
                    <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                        Register domains, configure allowed
                        origins, connect websites to SaaS
                        products, and manage tracking keys.
                    </p>
                </div>
