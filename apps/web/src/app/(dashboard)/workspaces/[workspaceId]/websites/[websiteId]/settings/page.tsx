        ...
        <div className="mx-auto max-w-4xl space-y-6">
            ...
            <header>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                    Manage lifecycle, application
                    connection and tracking-key security.
                </p>
            </header>
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="mt-3 text-sm text-red-600">
                        Rotation immediately invalidates
                        the previous key.
                    </p>
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Archiving keeps future analytics
                        history safe while disabling new
                        tracking events.
                    </p>
                </CardHeader>
                    ...
                    {website.archivedAt ? (
                        ...
                        <Button
                            ...
                            onClick={() => {
                                const confirmed =
                                    window.confirm(
                                        'Archive this website and disable tracking?',
                                    );
