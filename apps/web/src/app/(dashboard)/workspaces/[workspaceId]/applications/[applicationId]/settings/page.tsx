    ...
    async function handleDelete(): Promise<void> {
        ...
        try {
            ...
            setError(
                getErrorMessage(
                    actionError,
                    'Unable to permanently delete application.',
                ),
            );
            ...
            <Card>
                <CardHeader>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Archived applications remain in
                        the database but cannot be edited.
                    </p>
                </CardHeader>
                ...
                <CardContent>
                    {!canArchive ? (
                        <p className="text-sm text-slate-500">
                            Only workspace owners and
                            administrators can archive or
            ...
            <Card className="border-red-200">
                <CardHeader>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        ...
                        application, technology stack and
                        links forever.
                    </p>
                </CardHeader>
                ...
                <CardContent>
                    {!canDelete ? (
                        ...
                        <p className="text-sm text-amber-700">
                            Archive the application before
