    ...
    <div className="page-stack">
      <section className="page-heading split">
        <div>
          ...
          <p>
            Manage access and prepare this
            workspace for your SaaS portfolio.
          </p>
        </div>
      ...
      <section className="section-card">
        <div className="section-card-header">
          <div>
            ...
            <p>
              Update workspace information or
        ...
        <div className="action-grid">
          ...
          >
            ...
            <p>
              Add users and control workspace
              permissions.
            </p>
