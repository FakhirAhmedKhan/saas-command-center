    ...
    useEffect(
        () => {
            ...
            if (
                ...
                setError(
                    'GitHub did not return the required authorization information.',
                );
            ...
            void completeGithubCallback(
                code,
                state,
            )
                .then(
                    (
                        result: { workspaceId: string; repositoryCount: number; },
                    ) => {
                        setConnected(
                            true,
                        );
                        ...
                        window.setTimeout(
                            () => {
                                router.replace(
                                    `/workspaces/${result.workspaceId}/repositories?connected=1`,
                                );
                            },
                            900,
                        );
                ...
                {error ? (
                    ...
                    <>
                        ...
                        <p className="mt-3 text-sm text-slate-500">
                            Your repositories are ready. Redirecting to the workspace.
                        </p>
                    </>
                ) : (
                    <>
                        ...
                        <p className="mt-3 text-sm text-slate-500">
                            Verifying repository access and synchronizing your installation.
                        </p>
