...
export function AnalyticsEnginePanel({
    ...
    const [status, setStatus] =
        useState<AnalyticsEngineStatus | null>(
            null,
        );
    ...
    const [
        ...
        useState<AnalyticsAggregateResponse | null>(
            null,
        );

    const [period, setPeriod] =
        useState<AnalyticsAggregatePeriod>(
            'DAILY',
        );
    ...
    const [
        ...
        useState<AnalyticsAggregateDimension>(
            'OVERVIEW',
        );
    ...
    async function handleReprocess():
        ...
        if (
            ...
            setError(
                'Select both reprocessing dates.',
            );
        ...
        const confirmed =
            window.confirm(
                'Rebuild normalized analytics for this range?',
            );
            ...
            () =>
                reprocessAnalytics(
                    ...
                    websiteId,
                    {
                        dateFrom:
                            new Date(
                                `${reprocessFrom}T00:00:00.000Z`,
                            ).toISOString(),

                        dateTo:
                            new Date(
                                `${reprocessTo}T23:59:59.999Z`,
                            ).toISOString(),
            ...
            <Card>
                <CardHeader>
                    ...
                    <p className="mt-2 text-sm text-slate-500">
                        ...
                        session, source, or metric rules
                        change. Maximum range: 31 days.
                    </p>
                </CardHeader>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <Select
                            ...
                            onChange={(event) => {
                                ...
                                setPeriod(
                                    event.target
                                        .value as AnalyticsAggregatePeriod,
                                );
                            }}
                        >
                            <option value="HOURLY">
                        ...
                        <Select
                            ...
                            onChange={(event) => {
                                ...
                                setDimension(
                                    event.target
                                        .value as AnalyticsAggregateDimension,
                                );
                            }}
                        >
                            {DIMENSIONS.map(
                ...
                <CardContent>
                    <Button
                        ...
                        onClick={() => {
                            const confirmed =
                                window.confirm(
                                    'Run analytics retention cleanup now?',
                                );
