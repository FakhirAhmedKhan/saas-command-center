...
export type ApplicationPriority =
    (typeof APPLICATION_PRIORITIES)[number];
...
export type ApplicationCategory =
    (typeof APPLICATION_CATEGORIES)[number];
...
export type TechnologyType =
    (typeof TECHNOLOGY_TYPES)[number];
...
export type ApplicationLinkType =
    (typeof APPLICATION_LINK_TYPES)[number];
...
export type UpdateApplicationLinkPayload =
    Partial<CreateApplicationLinkPayload>;