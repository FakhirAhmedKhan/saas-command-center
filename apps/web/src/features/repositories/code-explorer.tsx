...
export function CodeExplorer({
    ...
    return (
        <div className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 shadow-xl">
            ...
            {error ? (
                <div className="border-b border-red-900 bg-red-950/60 px-4 py-2 text-xs text-red-300">
                    {
                        error
                    }
                </div>
                                ...
                                {tabs.map(
                                    (
                                        ...
                                        <button
                                            ...
                                            className={`flex h-10 max-w-56 items-center gap-2 border-r border-slate-800 px-3 text-xs ${tab.path ===
                                                    activePath
