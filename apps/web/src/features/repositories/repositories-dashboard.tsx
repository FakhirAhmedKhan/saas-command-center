...
export function RepositoriesDashboard({
  ...
  async function handleSyncRepository(
    ...
    try {
      ...
      setError(
        caughtError instanceof Error
          ? caughtError.message
          : 'Unable to synchronize the repository.',
      );
    } finally {
      setBusyKey(null);
    }
  ...
  async function handleDisconnect(
    ...
    const confirmed =
      window.confirm(
        `Disconnect ${installation.accountLogin} from this Command Center workspace?`,
      );
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Connect GitHub repositories to this workspace.
                </p>
              </div>
            </div>
          </div>
        ...
        {repositories.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-14 text-center">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm text-slate-500">
              Connect the Command Center GitHub App and choose the repositories
              this workspace should be allowed to access.
            </p>
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            {repository.isPrivate ? (
              ...
              <Unlock className="size-4 shrink-0 text-emerald-600" />
            )}
