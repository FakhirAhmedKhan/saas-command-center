...
import type { AnalyticsOverviewResponse } from './analytics-overview.types';
...
vi.mock('./use-analytics-overview', () => ({
...
describe('AnalyticsOverviewDashboard metric change formatting', () => {
  it('shows a positive-change badge with an up-arrow and the percentage value', () => {
    ...
    // mis-encoded glyph instead of U+2191 ("↑"), so real users saw "â†‘ 28%". The
