...
export const TASK_STATUS_LABELS: Record<ApplicationTaskStatus, string> = {
  TODO: 'To do',
  IN_PROGRESS: 'In progress',
  BLOCKED: 'Blocked',
  COMPLETED: 'Completed',
...
export const TASK_STATUS_VARIANTS: Record<ApplicationTaskStatus, BadgeVariant> = {
  TODO: 'slate',
  IN_PROGRESS: 'blue',
  BLOCKED: 'red',
  COMPLETED: 'green',
...
export const PRIORITY_VARIANTS: Record<WorkItemPriority, BadgeVariant> = {
  LOW: 'green',
  MEDIUM: 'blue',
  HIGH: 'orange',
  CRITICAL: 'red',
...
export const TEMPLATE_LABELS: Record<DevelopmentTemplateType, string> = {
