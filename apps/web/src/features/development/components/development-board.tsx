...
export function DevelopmentBoard({
    workspaceId,
    applicationId,
}: DevelopmentBoardProps) {
    const [
        summary,
        setSummary,
    ] =
        useState<DevelopmentSummary | null>(
            null,
        );
    ...
    const [
        ...
        useState<DevelopmentTemplate[]>([]);

    const [
        selectedTemplate,
        setSelectedTemplate,
    ] =
        useState<DevelopmentTemplateType>(
            'STANDARD_SAAS',
        );
    ...
    async function handleCreateMilestone(
        ...
        if (
            milestoneTitle.trim().length <
            2
        ) {
            setError(
                'Milestone title must contain at least two characters.',
            );
            return;
        }
            ...
            <Card>
                <CardContent className="p-10 text-center">
                    ...
                    <p className="mt-2 text-sm text-red-600">
                        {error ??
                            'Development data was not found.'}
                    </p>
                    ...
                    <div className="flex flex-col gap-3 lg:flex-row lg:items-end">
                        <Select
                            ...
                            onChange={(event) =>
                                setSelectedTemplate(
                                    event.target
                                        .value as DevelopmentTemplateType,
                                )
                            }
                        >
                            {templates.map(
