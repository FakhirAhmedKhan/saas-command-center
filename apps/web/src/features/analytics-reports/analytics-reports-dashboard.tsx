...
function normalizeTechnologyDimension(
    value: string | null,
): TechnologyDimension {
    if (
        value === 'browsers' ||
...
function isPageReport(
    report:
        AnalyticsReportResponse,
): report is PageReportResponse {
    return (
        'items' in report &&
        (
            report.items[0] ===
...
function isEventReport(
    report:
        AnalyticsReportResponse,
): report is EventReportResponse {
    return (
        'summary' in report
    );
}
            ...
            <table className="min-w-262.5 w-full border-collapse text-sm">
                <thead>
                    <tr className="border-b border-slate-200 bg-slate-50 text-left text-xs font-semibold uppercase tracking-wide text-slate-500">
                        ...
                        <th
                            className="px-4 py-3 text-right"
                            title="Sessions whose final page was this page."
                        >
                            Exits
                        </th>
                        ...
                        <th
                            className="px-4 py-3 text-right"
                            title="Average recorded page duration."
                        >
                            Avg. duration
                        </th>
                    </tr>
        ...
        <main className="space-y-5">
                    ...
                    {MAIN_TABS.map(
                        (
                            ...
                            <button
                                ...
                                className={`whitespace-nowrap border-b-2 px-4 py-3 text-sm font-medium ${tab ===
                                    item.value
            ...
            {loading ? (
                ...
                <EmptyState
                                ...
                                description="No matching analytics data was found for the selected filters and date range." icon={undefined}                />
            ) : (
