...
export const metadata: Metadata = {
    title: 'SaaS Command Center — Run Your SaaS From One Place',
    description:
...
const IconPulse = ({ className }: IconProps) => (
    ...
    >
        <path
            ...
            d="M3 12h4l2.2-5.5 4.2 11L16 12h5"
        />
    </svg>
);
...
function LogoMark() {
    return (
        <div className="relative flex h-8 w-8 items-center justify-center rounded-xl border border-white/15 bg-white text-black shadow-[0_0_35px_rgba(255,255,255,0.08)]">
            <div className="h-3.5 w-3.5 rounded-full border-[2.5px] border-black" />
            <div className="absolute right-[5px] top-[5px] h-1.5 w-1.5 rounded-full bg-blue-600" />
        </div>
    );
}
...
function SectionEyebrow({
    ...
    return (
        <div
            className={`mb-5 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-300 ${center ? 'justify-center' : ''
                }`}
        >
            ...
            <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-5 sm:px-6 lg:px-8">
                <Link href="/" className="group flex items-center gap-3">
                    ...
                    <div className="leading-none">
                        ...
                        <div className="mt-1 text-[9px] font-medium uppercase tracking-[0.18em] text-zinc-600">
                            Operations Platform
                        </div>
                    </div>
                </Link>
                ...
                <div className="flex items-center gap-2">
                    <Link
                        href="/login"
                        className="hidden rounded-full px-4 py-2 text-sm font-medium text-zinc-400 transition hover:text-white sm:block"
                    >
                        Sign in
                    </Link>
                    ...
                    <Link
                        href="/register"
                        className="hidden items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-black transition hover:bg-zinc-200 sm:flex"
                    >
                        Get started
                            ...
                            <div className="flex flex-col">
                                {[
                                    ...
                                    <Link
                                        key={href}
                                        href={href}
                                        className="rounded-xl px-4 py-3 text-sm text-zinc-400 transition hover:bg-white/5 hover:text-white"
                                    >
                                        {label}
                                    </Link>
                                ))}
                                ...
                                <Link
                                    href="/register"
                                    className="mt-1 rounded-xl bg-emerald-500 px-4 py-3 text-center text-sm font-semibold text-black"
                                >
                                    Create workspace
                                </Link>
                            </div>
...
function StatusPill({
    ...
    return (
        <span
            className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[10px] font-medium ${toneClass}`}
        >
        ...
        >
            ...
            <div className="overflow-hidden rounded-[24px] border border-white/[0.09] bg-[#080a0f] shadow-[0_50px_160px_rgba(0,0,0,0.72),0_0_0_1px_rgba(255,255,255,0.025)]">
                <div className="flex h-12 items-center justify-between border-b border-white/[0.07] bg-white/[0.018] px-4 sm:px-5">
                    ...
                    <div className="rounded-md border border-white/[0.06] bg-white/[0.025] px-2 py-1 font-mono text-[9px] text-zinc-600">
                        production
                    </div>
                </div>
                ...
                <div className="grid min-h-[580px] grid-cols-1 lg:grid-cols-[220px_minmax(0,1fr)]">
                    <aside className="hidden border-r border-white/[0.06] bg-black/20 p-4 lg:block">
                        ...
                        <div className="space-y-1">
                            {[
                                ...
                                return (
                                    <div
                                        key={label as string}
                                        className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-xs ${index === 0
                        ...
                        <div className="mt-8 border-t border-white/[0.06] pt-5">
                            <div className="mb-3 px-2 text-[9px] font-semibold uppercase tracking-[0.18em] text-zinc-700">
                                Infrastructure
                            </div>
                    ...
                    <div className="min-w-0 bg-[radial-gradient(circle_at_85%_0%,rgba(59,130,246,0.06),transparent_32%)] p-4 sm:p-6 lg:p-7">
                        <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                            <div>
                                <div className="text-[11px] font-medium uppercase tracking-[0.16em] text-zinc-600">
                                    Workspace overview
                                </div>
                            ...
                            <div className="flex items-center gap-2">
                                <div className="rounded-lg border border-white/[0.07] bg-white/[0.025] px-3 py-2 text-[10px] text-zinc-500">
                                    Last 24 hours
                                </div>
                                <div className="rounded-lg bg-white px-3 py-2 text-[10px] font-semibold text-black">
                                    + New application
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">
                            {[
                                ...
                                <div
                                    key={label}
                                    className="rounded-xl border border-white/[0.065] bg-white/[0.023] p-4"
                                >
                                ...
                                <div className="flex items-start justify-between gap-5">
                                    <div>
                                        ...
                                        <div className="mt-1 text-[10px] text-zinc-600">
                                            Events processed across your applications
                                        </div>
                                    </div>
                        ...
                        <div className="mt-3 grid gap-3 lg:grid-cols-2">
                            <div className="rounded-xl border border-white/[0.065] bg-white/[0.02] p-4 sm:p-5">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div
                                            key={name}
                                            className="flex items-center justify-between gap-4 rounded-lg border border-white/[0.05] bg-black/20 px-3 py-3"
                                        >
                            ...
                            <div className="rounded-xl border border-white/[0.065] bg-white/[0.02] p-4 sm:p-5">
                                ...
                                <div className="space-y-4">
                                    {[
                                        ['Deployment completed', 'Production · Web', 'Just now', 'blue'],
                                        ['Repository synchronized', 'GitHub · API', '4m ago', 'violet'],
                                        ['Analytics processing finished', '2,418 events', '9m ago', 'green'],
                                    ].map(([title, subtitle, time, tone]) => (
                                        <div key={title} className="flex items-start gap-3">
                                            <span
                                                className={`mt-1.5 h-2 w-2 shrink-0 rounded-full ${tone === 'blue'
                                                        ? 'bg-blue-400'
                                                        : tone === 'violet'
                                                            ? 'bg-violet-400'
                                                            : 'bg-emerald-400'
                                            ...
                                            <span className="whitespace-nowrap text-[8px] text-zinc-700">
                                                {time}
                                            </span>
                                        </div>
                                    ))}
            ...
            <div className="relative mx-auto max-w-7xl">
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <h1 className="text-balance text-[46px] font-semibold leading-[0.98] tracking-[-0.055em] text-white sm:text-6xl md:text-7xl lg:text-[82px]">
                        Your SaaS operation.
                        <span className="mt-2 block bg-gradient-to-r from-white via-blue-100 to-zinc-500 bg-clip-text text-transparent">
                            Finally in one place.
                        </span>
                    </h1>

                    <p className="mx-auto mt-7 max-w-2xl text-pretty text-base leading-7 text-zinc-400 sm:text-lg">
                        Bring repositories, applications, deployments, analytics, infrastructure health,
                        monitoring, and team operations into one command center built for developers.
                    </p>

                    <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                        <Link
                            href="/register"
                            className="group flex h-12 w-full items-center justify-center gap-2 rounded-full bg-white px-6 text-sm font-semibold text-black transition hover:bg-zinc-200 sm:w-auto"
                        >
...
function IntegrationStrip() {
    ...
    return (
        <section
            id="integrations"
            className="border-y border-white/[0.055] bg-white/[0.012] px-5 py-9 sm:px-6 lg:px-8"
        >
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.07] bg-white/[0.035] text-zinc-300">
                    {icon}
                </div>
                ...
                <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
                    <div>
                        ...
                        <h2 className="max-w-xl text-4xl font-semibold tracking-[-0.045em] text-white sm:text-5xl">
                            Stop operating your SaaS from ten different tabs.
                        </h2>
                    </div>

                    <div className="max-w-xl lg:justify-self-end">
                        <p className="text-base leading-7 text-zinc-500">
                            SaaS Command Center turns scattered operational data into one structured
                            workspace—giving your team a single place to understand what is running, what
                    ...
                    >
                        <div className="absolute inset-x-5 bottom-0 h-[235px] translate-y-4 overflow-hidden rounded-t-2xl border border-white/[0.07] bg-[#06080c] transition duration-500 group-hover:translate-y-1 sm:inset-x-8">
                            <div className="flex h-11 items-center justify-between border-b border-white/[0.06] px-4">
                                ...
                                <span className="rounded-md border border-white/[0.06] bg-white/[0.03] px-2 py-1 text-[8px] text-zinc-600">
                                    12 total
                                </span>
                            </div>
                        ...
                        <div className="absolute inset-x-6 bottom-6 rounded-2xl border border-white/[0.07] bg-black/40 p-4">
                            ...
                            <div className="mt-5 space-y-2 font-mono text-[9px]">
                                {[
                                    ...
                                    <div
                                        key={file}
                                        className="flex items-center justify-between border-b border-white/[0.045] pb-2 text-zinc-600 last:border-0"
                                    >
                    ...
                    >
                        <div className="absolute inset-x-6 bottom-6 space-y-2">
                            {[
                                ...
                                <div
                                    key={name}
                                    className="flex items-center gap-3 rounded-xl border border-white/[0.05] bg-white/[0.018] px-3 py-2.5"
                                >
                                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-zinc-800 text-[9px] font-semibold text-zinc-300">
                                        {initials}
                                    </div>
...
function Workflow() {
    const steps = [
        {
            ...
            description:
                'Create the operational home for your SaaS product and establish its access boundary.',
            icon: <IconStack className="h-5 w-5" />,
        },
        {
            number: '02',
            ...
            description:
                'Connect repositories and let Command Center inspect the technology and structure already in your codebase.',
            icon: <IconGitHub className="h-5 w-5" />,
        },
        {
            number: '03',
            ...
            description:
                'Organize applications, websites, environments, deployments, and monitoring under the workspace.',
            icon: <IconBolt className="h-5 w-5" />,
        },
        {
            number: '04',
            ...
            description:
                'Use one shared view for analytics, infrastructure health, code, releases, activity, and team access.',
            icon: <IconPulse className="h-5 w-5" />,
        },
    ];
    ...
    return (
        <section
            id="workflow"
            className="border-y border-white/[0.055] bg-white/[0.012] px-5 py-24 sm:px-6 sm:py-32 lg:px-8"
        >
            <div className="mx-auto max-w-7xl">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <h2 className="text-4xl font-semibold tracking-[-0.045em] text-white sm:text-5xl">
                        From repository to operations in minutes.
                    </h2>
                    <p className="mt-5 text-base leading-7 text-zinc-500">
                        Command Center is designed around the way software teams already work—not around
                        another complicated setup process.
                    </p>
                </div>
                ...
                <div className="relative mt-16 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    {steps.map((step) => (
                        <article
                            key={step.number}
                            className="relative rounded-[20px] border border-white/[0.065] bg-[#090b10] p-6"
                        >
            ...
            <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-2">
                <div>
                    ...
                    <p className="mt-6 max-w-xl text-base leading-7 text-zinc-500">
                        Every workflow is centered around repositories, environments, application state,
                        deployments, observability, and secure team collaboration.
                    </p>
                    ...
                    <div className="mt-9 grid gap-3 sm:grid-cols-2">
                        {[
                            ...
                            <div
                                key={feature}
                                className="flex items-center gap-3 rounded-xl border border-white/[0.055] bg-white/[0.018] px-4 py-3"
                            >
                    ...
                    <div className="overflow-hidden rounded-[22px] border border-white/[0.085] bg-[#07090d] shadow-[0_40px_120px_rgba(0,0,0,0.55)]">
                        ...
                        <div className="min-h-[370px] p-5 font-mono text-[11px] leading-7 sm:p-7">
                            <div className="text-zinc-600">
                                <span className="text-blue-400">❯</span> command-center connect github
                            </div>
                            ...
                            <div className="text-emerald-400">✓ Repository access granted</div>
                            <div className="text-emerald-400">✓ 3 applications detected</div>
                            <div className="text-emerald-400">✓ Workspace configuration generated</div>

                            <div className="mt-6 text-zinc-600">
                                <span className="text-blue-400">❯</span> command-center status
                            </div>

                            <div className="mt-4 grid grid-cols-[120px_1fr] gap-y-1 text-zinc-500">
                                <span>API</span>
                                <span className="text-emerald-400">healthy · 42ms</span>

                                <span>PostgreSQL</span>
                                <span className="text-emerald-400">healthy · 18ms</span>

                                <span>Redis</span>
                                <span className="text-emerald-400">healthy · 5ms</span>

                                <span>Deployment</span>
                                <span className="text-blue-300">production · active</span>
                            </div>
        ...
        <section className="border-y border-white/[0.055] bg-white/[0.012] px-5 py-24 sm:px-6 sm:py-32 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <h2 className="text-4xl font-semibold tracking-[-0.045em] text-white sm:text-5xl">
                        One control plane. Your entire stack.
                    </h2>

                    <p className="mt-5 text-base leading-7 text-zinc-500">
                        Connect the systems your team already uses without forcing your product into a new
                        deployment model.
                    </p>
                </div>
                        ...
                        <div className="grid gap-3 md:grid-cols-3">
                            {[
                                ...
                                return (
                                    <div
                                        key={title as string}
                                        className="rounded-2xl border border-white/[0.065] bg-white/[0.02] p-5 text-center"
                                    >
                    ...
                    <div className="grid lg:grid-cols-[0.95fr_1.05fr]">
                        <div className="relative border-b border-white/[0.06] p-8 sm:p-10 lg:border-b-0 lg:border-r lg:p-14">
                            ...
                            <div className="relative">
                                ...
                                <h2 className="max-w-lg text-4xl font-semibold tracking-[-0.045em] text-white">
                                    Built for production boundaries, not demo shortcuts.
                                </h2>

                                <p className="mt-5 max-w-lg text-sm leading-7 text-zinc-500">
                                    Authentication, workspace isolation, role checks, secure cookies, refresh-token
                                    rotation, webhook verification, rate limiting, and production configuration
                                    validation are first-class parts of the platform.
                                </p>
                            </div>
                        </div>
            ...
            <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.7fr_1.3fr]">
                <div>
                    ...
                    <h2 className="text-4xl font-semibold tracking-[-0.04em] text-white">
                        A few things teams ask first.
                    </h2>

                    <p className="mt-5 max-w-sm text-sm leading-6 text-zinc-500">
                        SaaS Command Center is designed as an operational layer around your existing
                        engineering stack.
                    </p>
                </div>
        ...
        <section className="px-5 pb-24 sm:px-6 sm:pb-32 lg:px-8">
            <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[30px] border border-white/[0.08] bg-[#0a0c12] px-6 py-20 text-center sm:px-10 sm:py-24">
                ...
                <div className="relative mx-auto max-w-3xl">
                    ...
                    <h2 className="text-balance text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl md:text-6xl">
                        Stop switching between dashboards.
                    </h2>

                    <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-zinc-500">
                        Create one workspace for the code, services, deployments, analytics, and people
                        behind your SaaS.
                    </p>
        ...
        <footer className="border-t border-white/[0.055] px-5 pb-8 pt-14 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
                    <div>
                        ...
                        <p className="mt-5 max-w-sm text-sm leading-6 text-zinc-600">
                            A centralized operations workspace for modern SaaS engineering teams.
                        </p>
                    </div>

                    <div>
                        <div className="mb-4 text-[10px] font-semibold uppercase tracking-[0.16em] text-zinc-700">
                            Product
                        </div>
                        <div className="space-y-3">
                            {[
                                ...
                                <Link
                                    key={label}
                                    href={href}
                                    className="block text-xs text-zinc-600 transition hover:text-white"
                                >
                                    {label}
                                </Link>
                            ))}
                ...
                <div className="mt-14 flex flex-col gap-4 border-t border-white/[0.055] pt-7 text-[10px] text-zinc-700 sm:flex-row sm:items-center sm:justify-between">
                    <p>© 2026 SaaS Command Center. All rights reserved.</p>
