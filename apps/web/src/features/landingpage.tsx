                        ...
                        <div className='space-y-1'>
                            {[
                                ...
                                return (
                                    <div
                                        key={label as string}
                                        className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-xs ${index === 0 ? 'border border-white/[0.06] bg-white/[0.055] text-white' : 'text-zinc-500'
                                            }`}
                                    >
                                ...
                                <div className='space-y-4'>
                                    {[
                                        ...
                                        <div key={title} className='flex items-start gap-3'>
                                            <span
                                                className={`mt-1.5 h-2 w-2 shrink-0 rounded-full ${tone === 'blue' ? 'bg-blue-400' : tone === 'violet' ? 'bg-violet-400' : 'bg-emerald-400'
                                                    }`}
                                            />
