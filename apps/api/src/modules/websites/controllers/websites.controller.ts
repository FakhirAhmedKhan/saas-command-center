...
export class WebsitesController {
    ...
    enable(
        ...
        return this.websitesService.enable(
            workspaceId,
            websiteId,
            request.user.id,
        );
    ...
    disable(
        ...
        return this.websitesService.disable(
            workspaceId,
            websiteId,
            request.user.id,
        );
    ...
    archive(
        ...
        return this.websitesService.archive(
            workspaceId,
            websiteId,
            request.user.id,
        );
    ...
    restore(
        ...
        return this.websitesService.restore(
            workspaceId,
            websiteId,
            request.user.id,
        );
    ...
    connect(
        ...
        return this.websitesService.connect(
            workspaceId,
            websiteId,
            dto,
            request.user.id,
    ...
    disconnect(
        ...
        return this.websitesService.disconnect(
            workspaceId,
            websiteId,
            request.user.id,
        );
