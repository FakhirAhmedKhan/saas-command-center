...
export class ReleaseDeploymentService {
  ...
  async updateRelease(
    ...
    if (
      ...
      throw new BadRequestException(
        'Version can only be changed while a release is Draft.',
      );
    }
  ...
  async createDeployment(
    ...
    if (
      input.healthIncidentId
    ) {
      await this
        .requireHealthIncident(
          workspaceId,
          applicationId,
          input
            .healthIncidentId,
          ...
          await transaction
            ...
            .create({
              data: {
                ...
                message:
                  `Deployment attempt ${attempt} created for ${environment.name}.`,
  ...
  async transitionDeployment(
    ...
    if (
      ...
      throw new BadRequestException(
        'scheduledAt is required when scheduling a deployment.',
      );
    }
    ...
    if (
      ...
      throw new BadRequestException(
        'failureReason is required when a deployment fails.',
      );
    }
    ...
    if (
      ...
      if (
        ...
        throw new BadRequestException(
          'rollbackToDeploymentId is required.',
        );
      }
      ...
      if (
        ...
        throw new BadRequestException(
          'A deployment cannot roll back to itself.',
        );
      }
      ...
      if (
        ...
        throw new BadRequestException(
          'Rollback target must belong to the same environment.',
        );
      }
      ...
      if (
        ...
        throw new BadRequestException(
          'Rollback target must be a successful deployment.',
        );
      }
    }
  ...
  private async requireHealthIncident(
    ...
    if (!incident) {
      throw new NotFoundException(
        'Health incident not found for this application.',
      );
    }
