...
export function normalizeRequestOrigin(
    ...
    if (
        ...
        throw new BadRequestException(
            'Request origin must use HTTP or HTTPS',
        );
    }
...
export function sanitizeTrackedUrl(
    ...
    if (
        ...
        throw new BadRequestException(
            'Tracked URL must use HTTP or HTTPS',
        );
    }
    ...
    if (
        ...
        throw new BadRequestException(
            'Tracked URL does not match the request origin',
        );
    }
...
export function sanitizeReferrerUrl(
    value?: string,
): string | null {
    if (!value) {
        return null;
