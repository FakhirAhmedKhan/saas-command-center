...
@Controller(
    'workspaces/:workspaceId/websites/:websiteId/tracking',
)
@UseGuards(
    JwtAuthGuard,
    WorkspaceAccessGuard,
...
export class TrackingAdminController {
    constructor(
        private readonly trackingAdminService:
            TrackingAdminService,
    ) { }
    ...
    getStatus(
        ...
        return this.trackingAdminService
            .getStatus(
                workspaceId,
                websiteId,
            );
