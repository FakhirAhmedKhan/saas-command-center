import { DevelopmentTemplateType, WorkItemPriority } from 'src/generated/prisma/enums';
...
export const DEVELOPMENT_TEMPLATES: Record<DevelopmentTemplateType, DevelopmentTemplateDefinition> = {
  STANDARD_SAAS: {
    type: DevelopmentTemplateType.STANDARD_SAAS,
    label: 'Standard SaaS',
    description: 'A general SaaS roadmap from product planning through launch.',
    milestones: [
      {
  ...
  AI_SAAS: {
    ...
    label: 'AI SaaS',
    description: 'An AI product roadmap including data, models, evaluation and product integration.',
    milestones: [
      {
  ...
  MOBILE: {
    ...
    description: 'A mobile roadmap covering UX, app architecture, features and store release.',
    milestones: [
      {
  ...
  API: {
    ...
    label: 'API product',
    description: 'An API roadmap covering contracts, security, reliability and release.',
    milestones: [
      {
        title: 'API contract',
  ...
  ECOMMERCE: {
    ...
    label: 'E-commerce',
    description: 'An e-commerce roadmap covering catalog, checkout, operations and launch.',
    milestones: [
      {
