...
} from '../templates/development-templates';
...
export class DevelopmentService {
    ...
    async getSummary(
        ...
        return this.getSummaryWithClient(
            this.prisma,
            workspaceId,
            applicationId,
        );
    ...
    async applyTemplate(
        ...
        const template =
            DEVELOPMENT_TEMPLATES[dto.template];

        if (!template) {
            throw new BadRequestException(
                'Development template not found',
            );
        }
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                const existingMilestones =
                    await transaction.applicationMilestone.count({
                        where: {
                            applicationId,
                        },
                    });
                ...
                for (
                    ...
                    const definition =
                        template.milestones[milestoneIndex];
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.DEVELOPMENT_TEMPLATE_APPLIED,
                        entityType:
    ...
    async createMilestone(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                const startsAt =
                    this.toNullableDate(dto.startsAt);
                ...
                const position =
                    await this.nextMilestonePosition(
                        transaction,
                        applicationId,
                    );
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.MILESTONE_CREATED,
                        entityType:
                            ActivityEntityType.MILESTONE,
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                if (
                    ...
                    throw new ConflictException(
                        'Reopen the milestone before editing it',
                    );
                }
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.MILESTONE_UPDATED,
                        entityType:
                            ActivityEntityType.MILESTONE,
    ...
    async completeMilestone(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                const openBlockers =
                    await transaction.applicationBlocker.count({
                        where: {
                            applicationId,
                            status: BlockerStatus.OPEN,
                            OR: [
                ...
                if (openBlockers > 0) {
                    throw new ConflictException(
                        'Resolve open blockers before completing this milestone',
                    );
                }
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.MILESTONE_COMPLETED,
                        entityType:
                            ActivityEntityType.MILESTONE,
                        entityId: milestoneId,
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.MILESTONE_REOPENED,
                        entityType:
                            ActivityEntityType.MILESTONE,
                        entityId: milestoneId,
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.MILESTONE_SKIPPED,
                        entityType:
                            ActivityEntityType.MILESTONE,
                        entityId: milestoneId,
    ...
    async deleteMilestone(
        ...
        await this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.normalizeMilestonePositions(
                    transaction,
                    applicationId,
                );
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.MILESTONE_DELETED,
                        entityType:
                            ActivityEntityType.MILESTONE,
                        entityId: milestoneId,
    ...
    async reorderMilestones(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                const milestones =
                    await transaction.applicationMilestone.findMany({
                        where: {
                            applicationId,
                        },
                        select: {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.MILESTONE_REORDERED,
                        entityType:
                            ActivityEntityType.APPLICATION,
                        entityId: applicationId,
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                if (
                    ...
                    throw new ConflictException(
                        'Reopen the milestone before adding tasks',
                    );
                }
                ...
                const position =
                    await this.nextTaskPosition(
                        transaction,
                        milestoneId,
                    );

                const task =
                    await transaction.applicationTask.create({
                        data: {
                            milestoneId,
                            title: this.requiredText(
                                dto.title,
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.TASK_CREATED,
                        entityType:
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.TASK_UPDATED,
                        entityType:
                            ActivityEntityType.TASK,
                        entityId: taskId,
                        title: 'Task updated',
    ...
    async setTaskStatus(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                const status =
                    dto.status as ApplicationTaskStatus;
    ...
    async completeTask(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                if (openBlockers > 0) {
                    throw new ConflictException(
                        'Resolve open blockers before completing this task',
                    );
                }
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.TASK_COMPLETED,
                        entityType:
                            ActivityEntityType.TASK,
                        entityId: taskId,
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.TASK_REOPENED,
                        entityType:
                            ActivityEntityType.TASK,
                        entityId: taskId,
                        title: 'Task reopened',
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.TASK_SKIPPED,
                        entityType:
                            ActivityEntityType.TASK,
                        entityId: taskId,
                        title: 'Task skipped',
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                if (
                    ...
                    throw new ConflictException(
                        'Tasks cannot be moved into a skipped milestone',
                    );
                }
                ...
                await this.normalizeTaskPositions(
                    transaction,
                    task.milestoneId,
                );
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.TASK_MOVED,
                        entityType:
                            ActivityEntityType.TASK,
                        entityId: taskId,
                        title: 'Task moved',
    ...
    async reorderTasks(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                const tasks =
                    await transaction.applicationTask.findMany({
                        where: {
                            milestoneId,
                        },
                        select: {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.TASK_REORDERED,
                        entityType:
                            ActivityEntityType.MILESTONE,
                        entityId: milestoneId,
                        title: 'Tasks reordered',
                        description:
                            'Tasks inside a milestone were reordered.',
                    },
                );
        ...
        await this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.TASK_DELETED,
                        entityType:
                            ActivityEntityType.TASK,
                        entityId: taskId,
                        title: 'Task deleted',
    ...
    async listBlockers(
        ...
        const where:
            Prisma.ApplicationBlockerWhereInput = {
            applicationId,
            ...(query.status
                ? {
                    status: query.status,
    ...
    async createBlocker(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                const blocker =
                    await transaction.applicationBlocker.create({
                        data: {
                            applicationId,
                            milestoneId,
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.BLOCKER_CREATED,
                        entityType:
                            ActivityEntityType.BLOCKER,
                        entityId: blocker.id,
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.BLOCKER_UPDATED,
                        entityType:
                            ActivityEntityType.BLOCKER,
                        entityId: blockerId,
    ...
    async resolveBlocker(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                if (blocker.taskId) {
                    await this.releaseTaskWhenUnblocked(
                        transaction,
                        blocker.taskId,
                    );
                }
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.BLOCKER_RESOLVED,
                        entityType:
                            ActivityEntityType.BLOCKER,
                        entityId: blockerId,
    ...
    async reopenBlocker(
        ...
        return this.prisma.$transaction(
            async (transaction) => {
                ...
                if (blocker.taskId) {
                    const task =
                        await transaction.applicationTask.findUnique({
                            where: {
                                id: blocker.taskId,
                            },
                        });
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.BLOCKER_REOPENED,
                        entityType:
                            ActivityEntityType.BLOCKER,
                        entityId: blockerId,
        ...
        await this.prisma.$transaction(
            async (transaction) => {
                ...
                await this.writeActivity(
                    ...
                    {
                        activityType:
                            ApplicationActivityType.BLOCKER_DELETED,
                        entityType:
                            ActivityEntityType.BLOCKER,
                        entityId: blockerId,
    ...
    private async getSummaryWithClient(
        ...
        const milestones =
            await client.applicationMilestone.findMany({
                where: {
                    applicationId,
                },
                orderBy: {
        ...
        const blockers =
            await client.applicationBlocker.findMany({
                where: {
                    applicationId,
                },
                orderBy: [
        ...
        const progress =
            this.progressCalculator.calculateSnapshot(
                milestones,
            );
        ...
        return {
            application: {
                ...
                progressUpdatedAt:
                    application.progressUpdatedAt,
                developmentTemplate:
                    application.developmentTemplate,
                templateAppliedAt:
                    application.templateAppliedAt,
            },
            progress,
            counts: {
                milestones:
    ...
    private async requireApplication(
        ...
        const application =
            await client.saasApplication.findFirst({
                where: {
                    id: applicationId,
                    workspaceId,
                },
    ...
    private ensureApplicationActive(
        application: {
        ...
        if (application.archivedAt) {
            throw new ConflictException(
                'Restore the application before modifying development records',
            );
        }
    }
    ...
    private async requireMilestone(
        ...
        const milestone =
            await client.applicationMilestone.findFirst({
                where: {
                    id: milestoneId,
                    applicationId,
                },
        ...
        if (!milestone) {
            throw new NotFoundException(
                'Application milestone not found',
            );
        }
    ...
    private async requireTask(
        ...
        const task =
            await client.applicationTask.findFirst({
                where: {
                    id: taskId,
                    milestone: {
                        applicationId,
    ...
    private async requireBlocker(
        ...
        const blocker =
            await client.applicationBlocker.findFirst({
                where: {
                    id: blockerId,
                    applicationId,
                },
    ...
    private async nextMilestonePosition(
        ...
        const result =
            await transaction.applicationMilestone.aggregate({
                where: {
                    applicationId,
                },
                _max: {
    ...
    private async nextTaskPosition(
        ...
        const result =
            await transaction.applicationTask.aggregate({
                where: {
                    milestoneId,
                },
                _max: {
    ...
    private validateOrderedIds(
        ...
        if (
            ...
            throw new BadRequestException(
                `All ${resourceName} must be included when reordering`,
            );
        }
        ...
        if (!valid) {
            throw new BadRequestException(
                `The ${resourceName} reorder list contains invalid IDs`,
            );
        }
    }
    ...
    private async writeActivity(
        ...
        await this.activityWriter.writeWithTransaction(
            transaction,
            {
                workspaceId:
                    application.workspaceId,
