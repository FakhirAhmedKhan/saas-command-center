...
export class WebhookDeliveryWorkerService {
    private readonly logger =
        new Logger(
            WebhookDeliveryWorkerService.name,
        );
            ...
            result =
                await this.outbound
                    .sendJson(
                        ...
                        {
                            'x-command-center-event':
                                delivery.event
                                    .type,

                            'x-command-center-event-id':
                                delivery.event
                                    .id,

                            'x-command-center-delivery-id':
                                delivery.id,

                            'x-command-center-timestamp':
                                timestamp,

                            'x-command-center-signature':
                                signature,

                            'x-command-center-webhook-version':
                                delivery.event
                                    .payloadVersion,
                        },
        ...
        await this.prisma
            ...
            .updateMany({
                ...
                data: {
                    ...
                    failureReason:
                        'Previous delivery worker stopped before completing the delivery.',
                },
            });
    }
}