...
@Controller('workspaces/:workspaceId/websites/:websiteId/analytics')
@UseGuards(JwtAuthGuard, WorkspaceAccessGuard)
export class AnalyticsOverviewController {
  constructor(private readonly analyticsOverviewService: AnalyticsOverviewService) {}

  @Get('overview')
  @ApiOperation({
    summary: 'Get website analytics overview',
  })
  @ApiOkResponse({
  ...
  getOverview(
    ...
    return this.analyticsOverviewService.getOverview(workspaceId, websiteId, query);
  }
}
