...
} from './monitoring-access.service';

import {
    SafeHttpClientService,
} from './safe-http-client.service';

type HealthCheckWithTarget =
            ...
            await this.prisma
                ...
                .update({
                    ...
                    data: {
                        ...
                        expectedStatusMin:
                            merged.expectedStatusMin,

                        expectedStatusMax:
                            merged.expectedStatusMax,

                        degradedAfterMs:
                            merged.degradedAfterMs,
    ...
    private validateConfiguration(
        ...
        if (
            ...
            throw new BadRequestException(
                'applicationId is required for an application health check.',
            );
        }
        ...
        if (
            ...
            throw new BadRequestException(
                'websiteId is required for a website health check.',
            );
        }
        ...
        if (
            ...
            throw new BadRequestException(
                'degradedAfterMs cannot exceed timeoutMs.',
            );
        }
    }
