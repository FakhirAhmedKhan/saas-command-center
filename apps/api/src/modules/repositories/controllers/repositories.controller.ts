...
export class RepositoriesController {
    ...
    syncOne(
        ...
        return this.repositoriesService.syncOne(
            workspaceId,
            repositoryId,
        );
    }
    ...
    linkApplication(
        ...
        return this.repositoriesService.linkApplication(
            workspaceId,
            repositoryId,
            dto.applicationId,
        );
    ...
    unlinkApplication(
        ...
        return this.repositoriesService.unlinkApplication(
            workspaceId,
            repositoryId,
        );
    }
    ...
    disconnectInstallation(
        ...
        return this.repositoriesService.disconnectInstallation(
            workspaceId,
