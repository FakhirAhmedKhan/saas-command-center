...
@Module({
  ...
  controllers: [RepositoriesController, GithubConnectController, GithubWebhookController, CodeExplorerController],

  providers: [GithubAppService, GithubCodeService, RepositoriesService, RepositoryConnectService, GithubWebhookService, CodeExplorerService],
