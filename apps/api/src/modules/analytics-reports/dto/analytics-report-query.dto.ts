...
} from '../../analytics-overview/dto/analytics-overview-query.dto';
...
export class AnalyticsReportQueryDto
    extends AnalyticsOverviewQueryDto {
    @ApiPropertyOptional({
        default: 1,
        minimum: 1,
    })
...
export class PageReportQueryDto
    extends AnalyticsReportQueryDto {
    @ApiPropertyOptional({
        enum:
            PageReportSortField,

        default:
            PageReportSortField.VIEWS,
    })
    @IsOptional()
    @IsEnum(
        PageReportSortField,
...
export class DimensionReportQueryDto
    extends AnalyticsReportQueryDto {
    @ApiPropertyOptional({
        enum:
        ...
        default:
            DimensionReportSortField.SESSIONS,
    })
    @IsOptional()
    @IsEnum(
        DimensionReportSortField,
