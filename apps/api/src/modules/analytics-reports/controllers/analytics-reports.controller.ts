...
@Controller('workspaces/:workspaceId/websites/:websiteId/analytics/reports')
...
export class AnalyticsReportsController {
  ...
  @Get('pages')
  @ApiOperation({
    summary: 'Get the detailed pages report',
  })
  @ApiOkResponse({
    type: PageReportResponseDto,
  })
  getPages(
    ...
    return this.analyticsReportsService.getPagesReport(workspaceId, websiteId, query);
  }

  @Get('events')
  @ApiOperation({
    summary: 'Get the custom events report',
  })
  @ApiOkResponse({
    type: EventReportResponseDto,
  })
  getEvents(
    @Param('workspaceId', ParseUUIDPipe)
    workspaceId: string,
    ...
    return this.analyticsReportsService.getEventsReport(workspaceId, websiteId, query);
  }

  @Get('dimensions/:dimension')
  @ApiOperation({
    summary: 'Get a dimension report',
  })
  @ApiOkResponse({
    type: DimensionReportResponseDto,
  })
  getDimension(
    @Param('workspaceId', ParseUUIDPipe)
    workspaceId: string,
    ...
    @Param('dimension', new ParseEnumPipe(AnalyticsReportDimension))
  ...
  @ApiOperation({
    summary: 'Export the pages report as CSV',
  })
  async exportPages(
    @Param('workspaceId', ParseUUIDPipe)
    workspaceId: string,
  ...
  @ApiProduces('text/csv')
  @ApiOperation({
    summary: 'Export the events report as CSV',
  })
  async exportEvents(
    @Param('workspaceId', ParseUUIDPipe)
    workspaceId: string,
  ...
  @Get('exports/dimensions/:dimension')
  @ApiProduces('text/csv')
  @ApiOperation({
    summary: 'Export a dimension report as CSV',
  })
