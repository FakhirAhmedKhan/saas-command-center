...
describe(
  ...
  () => {
    ...
    it(
      'writes activity for website creation and update',
      async () => {
        const owner =
    ...
    it(
      'writes activity for state, connection, and key-management actions',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'does not write activity for rejected validation',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'keeps website activity isolated across workspaces',
      async () => {
        const alphaOwner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'does not expose raw tracking keys or authentication secrets in activity',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
