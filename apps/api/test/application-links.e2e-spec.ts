...
describe(
    ...
    () => {
        ...
        it(
            'adds, updates, and removes a link',
            async () => {
                const owner =
        ...
        it(
            'rejects invalid and unsafe URLs',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'rejects invalid link type and empty label',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'rejects link ID from another application',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'rejects link changes on archived application',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
