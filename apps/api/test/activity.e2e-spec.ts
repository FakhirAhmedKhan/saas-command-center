...
describe(
    ...
    () => {
        ...
        it(
            'writes application create and update activities',
            async () => {
                const owner =
        ...
        it(
            'writes technology, link, archive, and restore activities',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'does not create activity for rejected operation',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'keeps workspace activity isolated',
            async () => {
                const alphaOwner =
                    await registerWorkspaceTestUser(
                        app,
                ...
                const wrongApplicationResponse =
                ...
                expect(
                    wrongApplicationResponse.status,
                ).toBe(404);
            },
        );
