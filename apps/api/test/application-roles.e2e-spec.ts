...
describe(
  ...
  () => {
    ...
    it(
      'allows OWNER, ADMIN, and DEVELOPER to create and update',
      async () => {
        const matrix =
    ...
    it(
      'allows OWNER, ADMIN, and DEVELOPER to manage technologies and links',
      async () => {
        const matrix =
          await createRoleMatrix();
    ...
    it(
      'allows VIEWER to read but prevents mutations',
      async () => {
        const matrix =
          await createRoleMatrix();
        ...
        expect(
          (
            await permanentlyDeleteApplication(
              matrix.viewer,
              application.id,
            )
          ).status,
    ...
    it(
      'prevents DEVELOPER from archive, restore, and delete',
      async () => {
        const matrix =
          await createRoleMatrix();
    ...
    it(
      'allows ADMIN to archive and restore but not permanently delete',
      async () => {
        const matrix =
          await createRoleMatrix();
    ...
    it(
      'allows OWNER to permanently delete archived application',
      async () => {
        const matrix =
          await createRoleMatrix();
