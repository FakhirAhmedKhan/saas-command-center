...
describe(
    ...
    () => {
        ...
        it(
            'rejects an invalid password without revealing account details',
            async () => {
                const user =
                    createTestUser();
        ...
        it(
            'rejects access to protected routes without an access token',
            async () => {
                const response =
                    await request(
                        app.getHttpServer(),
        ...
        it(
            ...
            async () => {
                ...
                expect(
                    refreshedAccessToken.length,
                ).toBeGreaterThan(20);

                const meAfterRefresh =
                    await agent
                        .get(
                            TEST_ROUTES.auth.me,
                        )
        ...
        it(
            'revokes the refresh session on logout',
            async () => {
                const user =
                    createTestUser();
