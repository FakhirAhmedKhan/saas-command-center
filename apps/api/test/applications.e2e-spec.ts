...
describe(
    ...
    () => {
        ...
        it(
            'creates an application with all supported fields',
            async () => {
                const owner =
        ...
        it(
            'creates an application using only required fields',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'rejects invalid application payloads',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'archives and restores an application',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'rejects changes to an archived application',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
        ...
        it(
            'rejects malformed application UUID',
            async () => {
                const owner =
                    await registerWorkspaceTestUser(
                        app,
