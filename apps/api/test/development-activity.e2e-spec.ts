...
describe(
  ...
  () => {
    ...
    it(
      'writes activity for milestone, task, and blocker creation',
      async () => {
        const owner =
    ...
    it(
      'writes activity for updates, completion, and blocker resolution',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'does not create activity for rejected validation',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'keeps development activity isolated between workspaces',
      async () => {
        const alphaOwner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'does not expose authentication secrets in development activity',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
