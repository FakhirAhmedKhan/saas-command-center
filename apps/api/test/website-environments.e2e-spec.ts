...
describe(
  ...
  () => {
    ...
    it(
      'disables and enables a website',
      async () => {
        const owner =
    ...
    it(
      'archives and restores a website',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'rejects regular mutations while archived',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'rotates the tracking key and returns a new raw key',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'connects and disconnects a website from an application',
      async () => {
        const owner =
          await registerWorkspaceTestUser(
            app,
    ...
    it(
      'rejects connection to a foreign or invalid application',
      async () => {
        const alphaOwner =
          await registerWorkspaceTestUser(
            app,
