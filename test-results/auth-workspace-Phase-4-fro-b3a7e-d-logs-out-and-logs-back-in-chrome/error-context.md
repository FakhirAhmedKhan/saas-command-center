...
- Name: auth-workspace.spec.ts >> Phase 4 frontend >> registers, shows dashboard, logs out and logs back in
- Location: ..\..\packages\test-code\web\e2e\auth-workspace.spec.ts:16:7
