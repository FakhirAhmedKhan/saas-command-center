...
- Name: batch10\applications.spec.ts >> Batch 10 application flows >> shows the active empty state
- Location: ..\..\packages\test-code\web\e2e\batch10\applications.spec.ts:32:7
