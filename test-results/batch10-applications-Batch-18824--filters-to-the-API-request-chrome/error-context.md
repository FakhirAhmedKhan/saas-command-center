...
- Name: batch10\applications.spec.ts >> Batch 10 application flows >> applies application search and status filters to the API request
- Location: ..\..\packages\test-code\web\e2e\batch10\applications.spec.ts:51:7
