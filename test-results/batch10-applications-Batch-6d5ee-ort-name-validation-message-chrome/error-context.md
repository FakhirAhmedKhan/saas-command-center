...
- Name: batch10\applications.spec.ts >> Batch 10 application flows >> shows the custom short-name validation message
- Location: ..\..\packages\test-code\web\e2e\batch10\applications.spec.ts:116:7
